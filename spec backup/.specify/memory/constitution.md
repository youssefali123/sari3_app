...
Added sections:
  - Principle I:   Feature-First Structure (Screaming Architecture)
  - Principle II:  Lightweight Clean Architecture per Feature
  - Principle III: Dependency Direction Is Fixed
  - Principle IV:  State Ownership Is Never Duplicated
  - Principle V:   The Server Is the Final Authority, Never the Client
  - Principle VI:  Concurrency-Critical Writes Must Be Atomic at the Database Level
  - Principle VII: Historical Records Are Immutable Snapshots
  - Principle VIII: Realtime and Push Notifications Are Separate Concerns
  - Principle IX:  Deferred Scope Must Not Require Future Rewrites
  - Principle X:   Practical MVP Simplicity Over Theoretical Purity
...
- Code reviews MUST verify that dependency direction (Principle III)
  and state ownership (Principle IV) are not violated.
